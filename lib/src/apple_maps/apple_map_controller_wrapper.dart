...
class AppleMapControllerWrapper extends PlatformMapControllerWrapper {
  final a.AppleMapController controller;
  final AppleMapMapper mapper;

  AppleMapControllerWrapper(this.controller, this.mapper);
  ...
  Future<LatLngBounds> getVisibleRegion() async {
    a.LatLngBounds googleBounds = await controller.getVisibleRegion();
